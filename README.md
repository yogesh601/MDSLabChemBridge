...
3. Check there should be these files
	...
	. NAMESPACE
4. Inside R folder check these files.
	. .Rhistory (file)
	. app_function.R (file)
5. Check if your R has installed devtools, if not, then install the package
6. Delete any old, broken versions first if you tried installation in wrong way
